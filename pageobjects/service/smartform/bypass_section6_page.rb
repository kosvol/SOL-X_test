...
class BypassPage < CommonFormsPage
  ...
  def trigger_pre_submission(_user, _condition)
    ...
    update_form_pre['variables']['formId'] = CommonPage.return_permit_id
    ...
    update_form_pre['variables']['answers'][7]['value']['AUTO_SOLX0004'] = CommonPage.return_rank_id
    ...
    update_form_pre_status['variables']['formId'] = CommonPage.return_permit_id
  ...
  def terminate_pre_permit(_user)
    ...
    create_form_pre['variables']['formId'] = CommonPage.return_permit_id
    create_form_pre['variables']['submissionTimestamp'] = get_current_date_time
  ...
  def trigger_forms_termination(permit_type, user, vessel, checklist, eic, gas)
    ...
    ServiceUtil.post_graph_ql('ptw/0.mod_create_form_ptw', user, vessel)
    CommonPage.set_permit_id(ServiceUtil.get_response_body['data']['createForm']['_id'])
    ...
    ServiceUtil.post_graph_ql('ship-local-time/base-get-current-time', user, vessel)
    @get_offset = ServiceUtil.get_response_body['data']['currentTime']['utcOffset']

    ### init dra form
    init_dra = JSON.parse JsonUtil.read_json(payload_mapper(permit_type, '00'))
    init_dra['variables']['parentFormId'] = CommonPage.return_permit_id
    ...
    ServiceUtil.post_graph_ql('ptw/0.mod_create_form_dra', user, vessel)
    ...
    if permit_type == 'submit_rigging_of_ladder'
      ...
      section['variables']['formId'] = CommonPage.return_permit_id
      ...
      ServiceUtil.post_graph_ql('ptw/mod_2.save_rol_dra_section_details', user, vessel)
      ...
      ServiceUtil.post_graph_ql('ptw/mod_3.save_rol_checklist_section_details', user, vessel)
      ...
      section['variables']['answers'][3].to_h['value']['signedBy'] = CommonPage.return_rank_id
      ...
      ServiceUtil.post_graph_ql('ptw/mod_16.update-active-status_rol', user, vessel)

      section = JSON.parse JsonUtil.read_json('ptw/rol/17.save_rol_task_status_section_details')
      section['variables']['formId'] = CommonPage.return_permit_id
      section['variables']['submissionTimestamp'] = get_current_date_time
      get_rank_id_from_service('A/M', vessel)
      section['variables']['answers'][10]['value']['AUTO_SOLX0012'] = CommonPage.return_rank_id
      JsonUtil.create_request_file('ptw/mod_17.save_rol_task_status_section_details', section)
      ServiceUtil.post_graph_ql('ptw/mod_17.save_rol_task_status_section_details', user, vessel)
      ...
      ServiceUtil.post_graph_ql('ptw/mod_3b.save_section3b_details', user, vessel)

      ### Section 3d
      section3d = JSON.parse JsonUtil.read_json('ptw/8.save_section3d_details')
      section3d['variables']['formId'] = CommonPage.return_permit_id
      ...
      ServiceUtil.post_graph_ql('ptw/mod_8.save_section3d_details', user, vessel)
      ...
      if checklist.nil?
        ...
        ServiceUtil.post_graph_ql('ptw/mod_21.save_section4a_details', user, vessel)
      end
      ### create eic ###
      unless eic.nil?
        create_eic = JSON.parse JsonUtil.read_json('ptw/11.create_eic')
        create_eic['variables']['parentFormId'] = CommonPage.return_permit_id
        ...
        ServiceUtil.post_graph_ql('ptw/mod_11.create_eic', user, vessel)

        ### save eic cert details ###
        save_eic = JSON.parse JsonUtil.read_json('ptw/11.save_eic_cert_details')
        save_eic['variables']['parentFormId'] = CommonPage.return_permit_id
        ...
        ServiceUtil.post_graph_ql('ptw/mod_11.save_eic_cert_details', user, vessel)

        ### section 4b ###
        section4b = JSON.parse JsonUtil.read_json('ptw/11.save_section4b_details')
        section4b['variables']['formId'] = CommonPage.return_permit_id
        ...
        ServiceUtil.post_graph_ql('ptw/mod_11.save_section4b_details', user, vessel)
      end
      ...
      ServiceUtil.post_graph_ql('ptw/mod_12.save_section5_details', user, vessel)

      ### Section 6
      unless gas.nil?
        section2 = JSON.parse JsonUtil.read_json('ptw/13.save_section6_details')
        section2['variables']['formId'] = CommonPage.return_permit_id
        ...
        ServiceUtil.post_graph_ql('ptw/mod_13.save_section6_details', user, vessel)
      end
      ...
      _update_permit['variables']['formId'] = CommonPage.return_permit_id
      ...
      ServiceUtil.post_graph_ql('ptw/mod_16.update-active-status', user, vessel)
      sleep(2)

      ### Section 8
      submit_active = JSON.parse JsonUtil.read_json('ptw/17.submit-for-termination-wo-eic-normalization')
      submit_active['variables']['formId'] = CommonPage.return_permit_id
      ...
      ServiceUtil.post_graph_ql('ptw/mod_17.submit-for-termination-wo-eic-normalization', user, vessel)
      ...
      ServiceUtil.post_graph_ql('ptw/mod_20.save_section9_details', user, vessel)
    end
  ...
  def trigger_forms_submission(_permit_type = nil, _user, _state, eic, _gas)
    ...
    create_form_ptw['variables']['answers'][0]['value'] =
      create_form_ptw['variables']['answers'][0]['value'].gsub('AUTO_SOLX0012',
                                                               CommonPage.return_rank_id.to_s)
    JsonUtil.create_request_file('ptw/0.mod_create_form_ptw', create_form_ptw)
    ...
    section3a['variables']['formId'] = CommonPage.return_permit_id
    ...
    section3b['variables']['formId'] = CommonPage.return_permit_id
    ...
    section3b['variables']['answers'][2]['value'] =
      "[{\"userId\":\"#{CommonPage.return_rank_id}\",\"rank\":\"MAS\"}]"
    ...
    section3c['variables']['formId'] = CommonPage.return_permit_id
    ...
    section3c['variables']['answers'][0]['value'] =
      "[{\"userId\":\"#{CommonPage.return_rank_id}\",\"rank\":\"A/M\"}]"
    ...
    section4ac['variables']['formId'] = CommonPage.return_permit_id
    ...
    if _state == 'active'
      submit_active = set_permit_status('ACTIVE')
      submit_permit_for_status_change(submit_active, '1111', _permit_type)
      set_update_require_for_permit(_permit_type, '1111')
    end
    ### End submit states
  end

  def submit_permit_for_status_change_to_uri(_submit_active, _user, _permit_type, _uri)
    _submit_active['variables']['formId'] = CommonPage.return_permit_id
    ...
    ServiceUtil.post_graph_ql('ptw/mod_15.submit-to-active', _user, _uri)
  end
  ...
  def set_update_require_for_permit(permit_type, user)
    ...
    update_permit['variables']['formId'] = CommonPage.return_permit_id
  ...
  def set_oa_permit_to_active_state(status)
    url = EnvironmentSelector.get_edge_db_data_by_uri("forms/#{CommonPage.return_permit_id.gsub('/',
                                                                                                '%2F')}?conflicts=true")
    ...
    submit_active['variables']['answers'][3].to_h['value'] =
      "{\"dateTime\":\"#{get_current_date_time}\",\"utcOffset\":#{ret_current_time_offset}}"
    submit_active['variables']['answers'].last['value'] =
      "{\"dateTime\":\"#{get_current_date_time_cal(8)}\",\"utcOffset\":#{ret_current_time_offset}}"
  ...
  def set_non_oa_permit_to_active_state
    ...
    submit_active['variables']['answers'][3].to_h['value'] =
      "{\"dateTime\":\"#{get_current_date_time}\",\"utcOffset\":#{ret_current_time_offset}}"
    submit_active['variables']['answers'].last['value'] =
      "{\"dateTime\":\"#{get_current_date_time_cal(2)}\",\"utcOffset\":#{ret_current_time_offset}}"
    JsonUtil.create_request_file('ptw/mod_16.update-active-status', submit_active)
    ServiceUtil.post_graph_ql('ptw/mod_16.update-active-status')
  end
  ...
  def set_rol_to_active(_duration)
    ...
    submit_active['variables']['answers'].last['value'] =
      "{\"dateTime\":\"#{get_current_date_time_cal(_duration)}\",\"utcOffset\":#{ret_current_time_offset}}"
    submit_active['variables']['submissionTimestamp'] = get_current_date_time
    get_rank_id_from_service('MAS')
    section['variables']['answers'][3].to_h['value']['signedBy'] = "\"#{CommonPage.return_rank_id}\""
  ...
  def submit_permit_for_termination_wo_eic_normalization(_status)
    ...
    get_rank_id_from_service('A/M')
    submit_active['variables']['answers'][-2].to_h['value']['signedBy'] = CommonPage.return_rank_id.to_s
    submit_active['variables']['submissionTimestamp'] = get_current_date_time
  ...
  def create_entry_record(_array, _type)
    ...
    when 'CRE', 'PRE'
      ...
      _entry_record['variables']['formId'] = CommonPage.return_permit_id
      ...
      _entry_record['variables']['crew_id'] = CommonPage.return_rank_id
  ...
  def create_entry_record_custom_gas_readings(_array, _type)
    ...
    get_rank_id_from_service('A C/O')
    _entry_record['variables']['crewId'] = CommonPage.return_rank_id if (_type == 'CRE') || (_type == 'PRE')
  ...
  def signout_entrants(_entrant_name)
    ...
    _entry_record['variables']['crewId'] = CommonPage.return_rank_id
