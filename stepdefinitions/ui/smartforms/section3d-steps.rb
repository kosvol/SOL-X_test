...
And (/^I fill up section 3d$/) do
  ...
  # on(Section3DPage).radio_btn_elements[[0, 1].sample].click
  # on(Section3DPage).radio_btn_elements[[2, 3].sample].click
  # on(Section3DPage).radio_btn_elements[[4, 5].sample].click
  # on(Section3DPage).radio_btn_elements[[6, 7].sample].click
end
