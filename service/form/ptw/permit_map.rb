...
class PermitMap
  PERMIT_MAP = {
    chemical_cleaning_of_fresh_water_gen: 'chemical_cleaning_of_fresh_water_gen',
    cold_work_line_cooldown: 'cold_work_line_cooldown',
    main_anchor: 'main_anchor',
    enclosed_spaces_entry: 'enclosed_spaces_entry',
    helicopter_operation: 'helicopter_operation',
    hot_work_outside_but_within: 'hot_work_outside_but_within',
    hot_work_designated: 'hot_work_designated',
    personnel_transfer: 'personnel_transfer',
    rigging_of_ladder: 'rigging_of_ladder',
    portable_tools_hydro_blaster: 'portable_tools_hydro_blaster',
    underwater_op: 'underwater_op',
    use_safe_camera: 'use_safe_camera',
    use_of_odme: 'use_of_odme',
    work_on_deck: 'work_on_deck',
    ele_equip_circuit: 'ele_equip_circuit',
    pressure_pipe_bunker_line: 'pressure_pipe_bunker_line',
    working_aloft_crane_wire: 'working_aloft_crane_wire',
  ...
  CHECKLIST_MAP = {
    cold_work_line_cooldown: 'openChecklistColdWorkOp',
    chemical_cleaning_of_fresh_water_gen: 'openChecklistWorkOnHazardousSubstances',
    ...
    hot_work_outside_but_within: 'openChecklistHotWorkOutsideDesignatedArea',
    hot_work_designated: 'openChecklistHotWorkWithinDesignatedArea',
    personnel_transfer: 'openChecklistPersonnelTransferByBasket',
    rigging_of_ladder: 'openChecklistRiggingOfLadder',
    portable_tools_hydro_blaster: 'openChecklistRotationalPortablePowerTools',
    underwater_op: 'openChecklistUnderwaterOp',
    ...
    pressure_pipe_bunker_line: 'openChecklistPressurePipelines',
    ele_equip_circuit: 'openChecklistElectricalEquipmentAndCircuit',
    working_aloft_crane_wire: 'openChecklistWorkingAloftOverside',
    lifting_operation: 'openChecklistLiftingOperation'
  }.freeze

  APPROVE_MAP = {
    cold_work_line_cooldown: 'PENDING_MASTER_APPROVAL',
    chemical_cleaning_of_fresh_water_gen: 'PENDING_MASTER_APPROVAL',
    ...
    hot_work_outside_but_within: 'PENDING_OFFICE_APPROVAL',
    hot_work_designated: 'PENDING_MASTER_APPROVAL',
    personnel_transfer: 'PENDING_MASTER_APPROVAL',
    rigging_of_ladder: 'PENDING_MASTER_APPROVAL',
    portable_tools_hydro_blaster: 'PENDING_MASTER_APPROVAL',
    underwater_op: 'PENDING_OFFICE_APPROVAL',
    ...
    pressure_pipe_bunker_line: 'PENDING_MASTER_APPROVAL',
    working_aloft_crane_wire: 'PENDING_MASTER_APPROVAL',
